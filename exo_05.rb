...
#Affiche la question ci-dessus suivie de sa réponse contenue dans les parenthéses. La réponse a la question est vrai.
# On demande a la console de donner la reponse sous forme boleene en utilisant le symbole ">", correspondant a "supérieur ou egale"
# on a donc une chaine de caratecre a laquelle on ajoute le resultat d'un calcul de variable.
puts "Est-ce que 5 est supérieur ou égal à -2 ? #{5 >= -2}"
# On constate que >= correspond a supérieur ou égale, donc si est ce que 5 est supérieur ou égale à -2? la réponse est vrai (true)
# en écrivant 5>= -2, la console nous répond "true". On a donc la version "littérale" et une version "mathématique".
